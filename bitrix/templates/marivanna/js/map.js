...
function initMap() {
    ...
    function renderMap(map, address){
    ...
    function addMarker(gmap, markerPos){

        var marker = new google.maps.Marker({
            position: markerPos,
            animation: google.maps.Animation.DROP,
            icon: '/bitrix/templates/marivanna/img/ico/map.png',
            map: gmap
        });
    ...
    $('#map').each(function(index, el) {
        ...
        var address = elMap.data('address');

        renderMap(el, address);
